...
import kotlinx.android.synthetic.main.four_floor.*
...
class FourFloorActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.four_floor)
    ...
    private fun defaultSeat() {
        ...
        val rowCount = fiveSeat.getJSONObject("Four Floor").getInt("totalRow")
        val columnCount = fiveSeat.getJSONObject("Four Floor").getInt("totalColumn")
        val seatArray = Array(rowCount) { Array(columnCount) { Seat() } }
        val rowArray = fiveSeat.getJSONObject("Four Floor").getJSONArray("rows")
